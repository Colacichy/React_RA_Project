...
function Sci() {
    ...
    const myBorder = {border:"1px black solid", borderBottom:"1px black dotted"}
    ...
    return(
        <>
            ...
            <div className="divTwo">
                ...
                <input type="radio" id="colorRed" name="color1" value="red" onChange={changeColor} />
                <label for="colorRed">red</label>

                <input type="radio" id="colorBlue" name="color1" value="blue" onChange={changeColor}/>
                <label for="colorBlue">blue</label>

                <input type="radio" id="colorGreen" name="color1" value="green" onChange={changeColor}/>
